  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-14 md:gap-22 lg:gap-38 xl:gap-54 lg:w-2/3 lg:pr-0 xl:w-1/2">
          {/* BIOGRAPHY CONTAINER */}
          ...
          <div
            className="flex flex-col gap-12 justify-center pb-28"
            ref={experienceRef}
          >
            <motion.h1
              initial={{ x: "-100px" }}
